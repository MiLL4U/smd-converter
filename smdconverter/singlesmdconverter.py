...
from ibwpy.main import BinaryWave5, BinaryWaveHeader5
...
class OperationButtonArray(ttk.Frame):
    def __init__(self, master: tk.Misc, commands: Dict[str, Any],
...
class App(tkdnd.Tk):
    ...
    def __create_widgets(self):
        ...
        op_commands = {'open': self.open_smd, 'remove': self.remove_job,
    ...
    def __set_jobs(self, file_names: Tuple[str]):
        ...
        for file_name in file_names:
            wave_name, extension = os.path.splitext(os.path.basename(file_name))
            if extension != '.smd':
